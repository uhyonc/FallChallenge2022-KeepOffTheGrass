...
import com.codingame.gameengine.runner.JavaPlayerAgent;
...
public class PlayerAgent extends JavaPlayerAgent {
     ...
     */
    public PlayerAgent(String className) {
    	super(className);
        codeMain = className;
